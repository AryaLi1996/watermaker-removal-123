...
Output: `release/SmootheVoice Watermark Remover-1.0.0-<arch>.dmg` — `arm64` on an Apple
...
`release/mac[-arm64]/SmootheVoice Watermark Remover.app`.
...
Output: `dist/SmootheVoice Watermark Remover Setup 1.0.0.exe`
...
Output: `dist/SmootheVoice Watermark Remover-1.0.0.AppImage`
...
```bash
chmod +x "SmootheVoice Watermark Remover-1.0.0.AppImage"
./"SmootheVoice Watermark Remover-1.0.0.AppImage"
```
...
gh release create v1.1.0 \
  --title "SmootheVoice Watermark Remover v1.1.0" \
  --notes-file CHANGELOG.md \
  "dist/SmootheVoice Watermark Remover-1.1.0.dmg" \
  "dist/SmootheVoice Watermark Remover Setup 1.1.0.exe" \
  "dist/SmootheVoice Watermark Remover-1.1.0.AppImage"
```
