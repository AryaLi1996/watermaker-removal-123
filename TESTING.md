...
|---|---|---|---|
| Backend (Python) | `npm run test:backend` | 206 pytest | `tests/unit/backend/` |
| Backend coverage | `npm run test:coverage` | ≥ 80% required | `htmlcov/` |
| Renderer (TypeScript) | `npm run test:frontend` | 107 vitest | `tests/unit/renderer/`, `renderer/src/` |
